...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"init\": () => (/* binding */ init)\n/* harmony export */ });\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var bootstrap_dist_js_bootstrap_bundle_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! bootstrap/dist/js/bootstrap.bundle.js */ \"./node_modules/bootstrap/dist/js/bootstrap.bundle.js\");\n/* harmony import */ var bootstrap_dist_js_bootstrap_bundle_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(bootstrap_dist_js_bootstrap_bundle_js__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _api_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./api.js */ \"./src/api.js\");\n/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils.js */ \"./src/utils.js\");\n/* harmony import */ var _templates_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./templates.js */ \"./src/templates.js\");\n/* harmony import */ var _bootstrap_min_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./bootstrap.min.css */ \"./src/bootstrap.min.css\");\n/* harmony import */ var _main_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./main.css */ \"./src/main.css\");\n/* eslint-disable import/prefer-default-export */\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nwindow.bootstrap = (bootstrap_dist_js_bootstrap_bundle_js__WEBPACK_IMPORTED_MODULE_1___default())\r\n// 初始化\r\nfunction init(options) {\r\n  // 起始參數\r\n  let count = 0\r\n  const LIMIT = 5\r\n\r\n  const { siteKey } = options\r\n  const { apiUrl } = options\r\n  const containerSelector = `.${options.containerClassName}`\r\n  const loadMoreClassName = `${siteKey}-loadmore`\r\n  const loadMoreSelector = `.${loadMoreClassName}`\r\n  const commentsClassName = `${siteKey}-comments`\r\n  const commentsSelector = `.${commentsClassName}`\r\n  const addCommentFormClassName = `${siteKey}-add-comment-form`\r\n  const addCommentFormSelector = `.${addCommentFormClassName}`\r\n  const wrapperClassName = `${siteKey}-board__wrapper`\r\n  const wrapperSelector = `.${wrapperClassName}`\r\n\r\n  // 插入留言板 template\r\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(containerSelector).append((0,_templates_js__WEBPACK_IMPORTED_MODULE_4__.getAddCommentForm)(addCommentFormClassName, commentsClassName, wrapperClassName))\r\n  // 載入留言\r\n  ;(0,_api_js__WEBPACK_IMPORTED_MODULE_2__.getNewComments)(apiUrl, siteKey, count, LIMIT, true, () => {\r\n    ;(0,_api_js__WEBPACK_IMPORTED_MODULE_2__.getNewComments)(apiUrl, siteKey, count + 1, LIMIT, false, () => {\r\n      count += 1\r\n      const loadMoreHTML = (0,_templates_js__WEBPACK_IMPORTED_MODULE_4__.getLoadMore)(loadMoreClassName)\r\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(commentsSelector).append(loadMoreHTML)\r\n    })\r\n  })\r\n\r\n  // 防止按 Enter 送出表單\r\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(addCommentFormSelector).submit((e) => {\r\n    e.preventDefault()\r\n  })\r\n\r\n  // 新增留言\r\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`${addCommentFormSelector} .btn-submit`).click((e) => {\r\n    const nicknameElement = jquery__WEBPACK_IMPORTED_MODULE_0___default()(`${addCommentFormSelector} input[name=\"nickname\"]`)\r\n    const contentElement = jquery__WEBPACK_IMPORTED_MODULE_0___default()(`${addCommentFormSelector} textarea[name=\"content\"]`)\r\n    const data = {\r\n      site_key: siteKey,\r\n      nickname: nicknameElement.val(),\r\n      content: contentElement.val(),\r\n      created_at: (0,_utils_js__WEBPACK_IMPORTED_MODULE_3__.date)()\r\n    }\r\n    ;(0,_api_js__WEBPACK_IMPORTED_MODULE_2__.addComment)(apiUrl, data, () => {\r\n      // 清空\r\n      nicknameElement.val('')\r\n      contentElement.val('')\r\n    })\r\n  })\r\n\r\n  // 載入更多\r\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(commentsSelector).on('click', loadMoreSelector, (e) => {\r\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(e.target).parent().remove()\r\n    // 顯示留言\r\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(`${commentsSelector} [data-id=\"${count}\"].toast`).parent().removeClass('hide')\r\n    // 撈留言（ 隱藏 ）\r\n    ;(0,_api_js__WEBPACK_IMPORTED_MODULE_2__.getNewComments)(apiUrl, siteKey, count + 1, LIMIT, false, () => {\r\n      count += 1\r\n      const loadMoreHTML = (0,_templates_js__WEBPACK_IMPORTED_MODULE_4__.getLoadMore)(loadMoreClassName)\r\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(commentsSelector).append(loadMoreHTML)\r\n    })\r\n  })\r\n\r\n  // 刷新\r\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`${addCommentFormSelector} .btn-refresh`).click((e) => {\r\n    e.preventDefault()\r\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(commentsSelector).empty()\r\n    count = 0\r\n    // 載入留言\r\n    ;(0,_api_js__WEBPACK_IMPORTED_MODULE_2__.getNewComments)(apiUrl, siteKey, count, LIMIT, true, () => {\r\n      ;(0,_api_js__WEBPACK_IMPORTED_MODULE_2__.getNewComments)(apiUrl, siteKey, count + 1, LIMIT, false, () => {\r\n        count += 1\r\n        const loadMoreHTML = (0,_templates_js__WEBPACK_IMPORTED_MODULE_4__.getLoadMore)(loadMoreClassName)\r\n        jquery__WEBPACK_IMPORTED_MODULE_0___default()(commentsSelector).append(loadMoreHTML)\r\n      })\r\n    })\r\n  })\r\n\r\n  // 回到頂部\r\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`${wrapperSelector} .btn-gotop`).click((e) => {\r\n    const wrapperParent = document.querySelector(wrapperSelector).parentNode\r\n    // 測試是否有垂直滾動軸\r\n    if (wrapperParent.scrollHeight > wrapperParent.clientHeight) {\r\n      wrapperParent.scrollTop = 0\r\n    } else {\r\n      const currentScrollTop = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop()\r\n      const rect = wrapperParent.getBoundingClientRect()\r\n      const scrollDistance = rect.top + currentScrollTop\r\n      window.scroll(0, scrollDistance)\r\n    }\r\n  })\r\n\r\n  // 移至最底\r\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(`${wrapperSelector} .btn-gobottom`).click(() => {\r\n    count = 0\r\n    const wrapperElement = document.querySelector(wrapperSelector)\r\n    const wrapperParent = wrapperElement.parentNode\r\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(commentsSelector).empty()\r\n    ;(0,_api_js__WEBPACK_IMPORTED_MODULE_2__.getAllComments)(apiUrl, siteKey, () => {\r\n      // 測試是否有垂直滾動軸\r\n      if (wrapperParent.scrollHeight > wrapperParent.clientHeight) {\r\n        wrapperParent.scrollTop = wrapperElement.offsetHeight - wrapperParent.offsetHeight\r\n      } else {\r\n        const currentScrollTop = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop()\r\n        const rect = wrapperParent.getBoundingClientRect()\r\n        const scrollDistance = rect.top + rect.height + currentScrollTop - window.innerHeight\r\n        window.scroll(0, scrollDistance)\r\n      }\r\n    })\r\n  })\r\n}\r\n\n\n//# sourceURL=webpack://commentPlugin/./src/index.js?");
