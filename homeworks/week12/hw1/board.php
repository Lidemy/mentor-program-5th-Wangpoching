  ...
  <body> 
    ...
    <div class="container bg-light py-5 main">
      ...
      <form class="add-comment-form">
        ...
        <a type="submit" class="btn btn-primary mt-3 btn-refresh" href="http://mentor-program.co/mtr04group3/Wangpoching/api_based_board/board.php">刷新頁面</a>
      </form>
      <div class="comments row justify-content-center mt-5">
      </div>
    </div>
    <div class="container fixed-bottom d-flex flex-row-reverse bg-dark">
      <div class="dropup">
